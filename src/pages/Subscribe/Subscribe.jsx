...
export default function Subscribe() {
    ...
    return (
        <div className='subscribe contact' id='contact'  >
            <h2 data-aos="fade-down" data-aos-duration="700"  data-aos-easing="ease-in-sine">Ignite Your Child's Potential Take the Leap with an Online Course</h2>
            <form  className="subscribe-form" onSubmit={sendEmail} ref={form} data-aos="fade-down" data-aos-duration="700"  data-aos-easing="ease-in-sine">
                <div className="input">
